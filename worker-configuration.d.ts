/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e164d660fa907716dd2094875369afe)
// Runtime types generated with workerd@1.20260917.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	CLIENT_RATE_LIMIT: RateLimit;
	GLOBAL_RATE_LIMIT: RateLimit;
	REQUEST_RATE_LIMIT: RateLimit;
	SHARE_READ_RATE_LIMIT: RateLimit;
	SHARE_GLOBAL_RATE_LIMIT: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	TURNSTILE_SITEKEY: "0x4AAAAAAE64yf1Lv7dzlttY";
	TURNSTILE_HOSTNAMES: "ytdw.fyi,www.ytdw.fyi,ytdw.simons.workers.dev";
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	COORDINATOR: DurableObjectNamespace<import("./src/index").Coordinator>;
	SHARED_BRIEFS: DurableObjectNamespace<import("./src/index").SharedBrief>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "Coordinator" | "SharedBrief";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_HOSTNAMES">> {}
}
